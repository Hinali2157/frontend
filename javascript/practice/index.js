...
// let nature = [1, 2, 3, 4, 5, 6, 7, 11]
// console.log(nature);
// let everyfun= nature.every((number)=> number>10)
// let somefun= nature.some((number)=> number>10)
// console.log(everyfun);
// console.log(nature);
// console.log(somefun);
// console.log(nature);

// array fill method //deep copies
// let nature = [1, 2, 3, 4, 5, 6, 7, 11]
// console.log(nature);
// let fillfun = nature.fill(50,3)
// console.log(fillfun);
// console.log(nature);

// reduce method , reduceright method 
// let number= [100,20,50,40,85]
// let sum=number.reduce((first,second)=>first + second)
// let sumright=number.reduceright((first,second)=>first + second)
// console.log(sum);

//flat method shallow copy
// let number = [100, 20, 85, [10, 20, [30, 40]]]
// console.log(number);
// let flatfun = number.flat(2)
// console.log(flatfun);
// console.log(number);

// flatmap method shallow copy
// let number = [20, 50, 100, [50, 10, [80, 40]]]
// console.log(number);

// let flatmapfun = number.flat(2)
// let fun = flatmapfun.flatMap((value) => value * 3)
// console.log(flatmapfun);
// console.log(number);
// console.log(fun);
// console.log(number);

// array sort method shallow copy
// let number = [20, 50, 100, [50, 10, [80, 40]]]
// console.log(number);
// console.log(number.flat(2).sort());
// console.log(number);
